defmodule ProjetZWeb.WorkingTimeControllerTest do
  use ProjetZWeb.ConnCase
  ...
  @update_attrs %{
    start_time: ~U[2023-10-24 16:43:00Z],
    end_time: ~U[2023-10-24 16:43:00Z]
  }
  ...
  describe "create working_time" do
    test "renders working_time when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end_time" => "2023-10-23T16:43:00Z",
               "start_time" => "2023-10-23T16:43:00Z"
  ...
  describe "update working_time" do
    ...
    test "renders working_time when data is valid", %{conn: conn, working_time: %WorkingTime{id: id} = working_time} do
      ...
      assert %{
               "id" => ^id,
               "end_time" => "2023-10-24T16:43:00Z",
               "start_time" => "2023-10-24T16:43:00Z"
             } = json_response(conn, 200)["data"]
    end
